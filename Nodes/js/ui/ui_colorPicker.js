...
/*         this.colorPickerBox = new Box(this.app, 0, 0, 300, 600, "Color Picker");
        ...
        this.rgbButton = new LabeledButton(this.app, 15, 300, 85, 25, "RGB");
        this.addChild(this.rgbButton.container);
        this.hsvButton = new LabeledButton(this.app, 107.5, 300, 85, 25, "HSV");
        this.addChild(this.hsvButton.container);
        this.hexButton = new LabeledButton(this.app, 200, 300, 85, 25, "HEX");
        this.addChild(this.hexButton.container);
        ...
        this.sliderLimListItem("Red", "float", 0, 255, this.r, 330);
        this.sliderLimListItem("Green", "float", 0, 255, this.r, 360);
        this.sliderLimListItem("Blue", "float", 0, 255, this.r, 390);
        this.sliderLimListItem("Alpha", "float", 0, 255, this.r, 420);
